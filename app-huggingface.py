"""
app-huggingface.py — AI Pioneers Week 3 Demo
IT Operations Chatbot with Conversation Memory (Hugging Face)
Mayank Chugh | Azure OpenAI & GenAI Architecture | 2026

Run locally:
    streamlit run app-huggingface.py
...
client = get_client(os.environ.get("HF_TOKEN", ""))
...
with st.sidebar:
    ...
    with st.expander("ℹ️  About this app"):
        st.markdown("""
        **Built with:**  
        `Python` · `Streamlit` · `Hugging Face Inference API`
...
if not client:
    ...
    <div style="background:#0D1F35; border:1px solid #F59E0B; border-radius:12px; padding:20px; margin:20px 0">
        ...
        <div style="color:#94A3B8; font-size:13px; line-height:1.6">
            Set your <code>HF_TOKEN</code> environment variable to use this chatbot.<br><br>
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            full_response = "❌ Invalid API key. Check your `HF_TOKEN` environment variable."
