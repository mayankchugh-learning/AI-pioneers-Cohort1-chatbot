...
client = get_client(os.environ.get("OPENAI_API_KEY", ""))
...
if not client:
    ...
    <div style="background:#0D1F35; border:1px solid #F59E0B; border-radius:12px; padding:20px; margin:20px 0">
        ...
        <div style="color:#94A3B8; font-size:13px; line-height:1.6">
            Set your <code>OPENAI_API_KEY</code> environment variable to use this chatbot.<br><br>
...
if user_input:
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            full_response = "❌ Invalid API key. Check your `OPENAI_API_KEY` environment variable."
